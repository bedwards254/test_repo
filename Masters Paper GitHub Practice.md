...
The term Òcommunity archive,Ó as defined by Joanna Newman in 2011, represents the 
Òcollections of archival records that originate in a community...and whose collection, 
maintenance and use involves active participation of that communityÓ (p. 38). The mention of 
...
factor in how these archives continue but having someone Òwith skills and possibly specialist 
servicesÓ supported in order to not lose the Òpassion and connection...brought by enthusiastsÓ is 
just as important (Newman, 2011, p. 41). Bringing the community together at the beginning and 
encouraging interest in the archive can help lay a foundation to help support the archive later on. 
This impact is felt most when a ÒgapÓ in the narrative is filled; a group underrepresented in the 
...
Communities allowed to make Òcollective decisions about what is of enduring value to them, 
shape collective memories of their own pasts, and control the means through which stories about 
their past are constructed,Ó create more complete archives, and end up being more useful to the 
community in the long run, due to the input from the beginning (Caswell, Cifor, & Ramirez, 
2016, p. 61). Community archives can help build a larger, more complete history of a place, 
institution, or group with these stories which come to light, providing a stronger sense of self 
value and worth. The impact of saying Òwe were here,Ó and having materials and history to back 
up that claim, especially if previously undocumented, adds to the value of a community and can 
encourage them to keep saying ÒI am here,Ó adding to their identity (Caswell et al., 2016, p. 75). 
Bringing forward these stories help communities define themselves and see themselves in a 
different light, and in a different way in how they interact with the world around them. 
...
pulls back for whatever reason. Being an agent for your cause is important, and a Òparticipatory 
approachÓ can help those left in charge to navigate these programs head-on. </br>
A Òparticipatory approachÓ involves allowing different views of Òcustody and management, 
and...archival practice, and of collection and value [that] are considered and embracedÓ (Flinn & 
Andrew, 2011, p. 15). This leads to a wider area of thought and acceptance to really make their 
...
other groups, or even schools, this collaboration can help foster a Òwider sense of ownership and 
responsibility toward the archive and the archive service,Ó which can help sustain interest in the 
long run (Flinn & Andrew, 2011, p. 1). This approach also gives community members the 
chance Òto speak for themselves and decide whether they wish to be included [in the archive],Ó 
which feeds into letting them control their own community narrative and how they are 
represented in history (Flinn & Andrew, 2011, p. 17). This also allows for the community to 
...
provides insight into priorities and levels of importance (Freedley, 1962). The students discussed 
...
playbills, books, photographs, and original designs (Freedley, 1962, p. 54-55). Comparing these 
...
Òcreating and curating representations of an ephemeral art form,Ó since these representations 
vary from art form to art form (Jones, Abbott, & Ross, 2009, p. 165). With the evolution of 
...
realize the Òstandardization of practice was possible without compromising the uniqueness of 
collectionsÓ (Fern, 2004, p. 198). This has allowed archivists nationwide to create a general 
...
A question which plagues theatre archives can also be applied to community and Òpop-upÓ 
...
events, such as Occupy Wall Street. These dramatic events cause archivists to ask, ÒHow do you 
capture the mood of the time or reflect what it meant to take part in or live through such 
experiences?Ó (Jones et al., 2009, p. 167). Recreating the experience of actually being there is 
...
interpretations of a singular source material as it continues to be performed (Jones et al., 2009, 
page 169). Both types of archives must be open to constant change and use to be considered 
...
shape possible. These can include audio and video recordings, Òmanuscripts, photographs, and 
artworkÓ related to theatres in these collections, which can help Òdocument and support researchÓ 
(Russell, 2016, p. 63). However, these can also include items such as set models, costumes, 
scripts, and even potentially props from specific shows, if deemed important enough. These 
materials, along with ephemeral items, help historians Òreconstruct what Gordon Craig describes 
as the artistry of theatre: the Ôaction, scene, and voiceÕ,Ó which helps bring the production to life 
in the researcher's mind (Harvey & Moosberger, 2007, p. 44). However, deciding what to keep 
...
how the term Òresearch valueÓ can differ between different collections. For example, she chose 
to list items with Òpermanent research valueÓ for both the Literary Archives and the Performing 
...
focus (Hujda, SAA 2017). This breakdown really showcases what researchers find valuable, and 
...
donÕt fully help a researcher understand a show or overwhelms them to the point where they 
canÕt find any information. With the mix of materials found in these archives (mentioned 
...
as the Òsubtle interactions between artist, venue, and audience that add character and vitality to 
live art,Ó which cannot be replicated, and varies from performance to performance (Jackson, 
Wheeler, & Quinn, 2015, p. 22). This is where records such as audience narratives or responses 
...
important to consider, taking in outside factors such as the Òsocial, political, economic, and 
artistic contextsÓ to fully understand a performance and why certain choices were made in 
response to the surrounding climate (Marini, 2007, p. 20). Audience reaction also falls into the 
...
Since Òperformance is something that does not last...[and this] is exactly what fascinates theatre 
practitioners and scholars alike,Ó the research process for these groups is influenced by this fact 
(Marini, 2007, p. 18). Accepting that performance is ephemeral can help inspire new 
interpretations of classic works, creating a new experience each time for audiences. Another 
unique aspect to these archives is that Òperforming arts librarians and archivists are often 
themselves practitioners,Ó which brings a different Òlevel of interest and engagement to the 
research processÓ (Jackson et al., 2015, p. 21). This personal touch helps elevate the work of a 
...
set sketches (Marini, 2007, p. 26). This knowledge of both theatre and archival work also lends 
...
archives both. Hackman proclaims he thinks of Òadvocacy as an investment we make when we 
intentionally and strategically educate and engage individuals and organizations so they in turn 
will support our work,Ó which can be seen in the continued existence and growth of community 
and theatre archives (Hackman, 2012, p. 11). Think of a successful theatre you know, either 
...
times. If itÕs a community archive, this support goes even deeper, maybe even to the governing 
level, as seen in Lisa Collins ShortallÕs 2016 article on the County Offaly archives in Ireland. 
...
archive or theatre itself. Community archives in particular have an importance in Òshaping the 
local historical narrative, collective identity and social memory of a localityÓ (Collins Shortall, 
2016, p. 144). In a way, where institutional archives have gaps, community archives can form 
and fill in those gaps, by collecting unheard narratives and objects institutions may not be able to 
take in at a certain time. Location could also play a part in this, with the Òdesire to physically 
secure...archival collections in a geographical provenance-based locationÓ showing the 
importance of the collections to the community and how they would like to have them on hand, 
to both care for and to use at will (Collins Shortall, 2016, p. 150). Some theatre archives have 
taken this approach, with the theatres themselves maintaining their own archives, instead of 
donating it to a local repository to Òkeep it in the familyÓ and for their own reference uses. 
...
important to collect to help support scholarship in a number of fields (Smith, 2013, p. 61). 
Although video recordings exist, due to rules set forth by the ActorsÕ Equity Association they 
...
collaboration and allow them to Òcombine old and new information (research, observations, 
memories, experiences, relationships) in unique ways,Ó creating a new experience for the 
audience each and every time (Medaille, 2010, p. 345). Creating this environment for the 
...
TLA joint conference, the main goals of the project were to Òprepare archival guidelines for 
...
in academic settings, and how theatre and ILS students can become involvedÓ in this project, 
with each team (Brady & Koffler, 2015, p. 106). Inspired by the Dance Heritage Coalition and 
...
repositories (Brady & Koffler, 2015, p. 106). By fall of 2010, there were a number of teams in 
the United States and one in Canada, pulled together by an interest survey which was sent out 
(Brady & Koffler, 2015, p. 107). With so many excited and willing Òteams,Ó guidelines and 
...
hand out to initial sites (Brady & Koffler, 2015, p. 107-8). The first test of the project began in 
fall of 2011 in New York City (NYC), where a workshop ÒscriptÓ was given to archivist and 
NYC team members (Brady & Koffler, 2015, p. 108). Versions of this workshop have been 
...
nationwide, becoming an official standing committee of ASTR in 2014 (Brady & Koffler, 2015, 
p. 113). Meeting every year for an update at the ASTR- TLA annual meeting, ATAP is still 
...
meetings to keep in touch and up to date on projects (Brady & Koffler, 2015, p. 114). Over the 
years, the Northwest team Òdeveloped the confidence and experience to work directly with 
theatre companies and approach external funders for support through a fairly lengthy processÓ 
(Brady & Koffler, 2015, p. 117-119). This included a survey of existing collections throughout 
...
the same lines as well. Some teams, such as the New York team, have their own websiteÑ
separate from the overall ATAP websiteÑ which keeps team members updated about ongoing 
projects, new projects, and meeting minutes. </br>

### North Carolina and the American Theatre Archive Project 
North Carolina has had an ATAP regional team since around 2012-2013. While not yet at the 
scale it wants to be, the teamÕs goals remain the same: to create an archive for the University of 
North Carolina at Chapel HillÕs performing arts groups, ranging from PlayMakers to the UNC 
...
Repertory Company archive, due to their historical significance as being the Òsecond oldest 
theatre department in the countryÓ (ÒAbout Us | UNC Department of Dramatic Art,Ó n.d.). While 
some of its records are held on UNCÕs campus, there are other records they wish to have 
...
leader, which he sees as an Òextension of [his] dramaturgical workÓ (personal communication, 
October 12, 2017). In fall 2014, the Community Archives class taught by Dr. Denise Anthony, 
...
already in the ÒarchiveÓ within the Center for Dramatic Art (CDA) and compiled a report with 
